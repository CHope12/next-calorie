    ...
    <DefaultLayout>
      <div className="rounded-sm border border-stroke bg-white px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
        <div className="mx-auto max-w-[410px]">
          <img src="/images/illustration/illustration-01.svg" />
          <div className="mt-7.5 text-center">
            <h2 className="mb-3 text-2xl font-bold text-black dark:text-white">
              Sorry, this page is still under construction.
            </h2>
            <p className="font-medium">
              We are working hard to bring you new features and improvements. Stay tuned!
            </p>
            <Link href="/" className="mt-7.5 inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 font-medium text-white hover:bg-opacity-90">
